...
def main():
    ...
    search_space = [
        ...
        # h100_saturated profile 110M params + 512 seq_len
        {"arch": "hybrid", "embed_dim": 768, "n_heads": 12, "n_layers": 12, "batch_size": 512, "precision": "fp8",  "max_seq_len": 512},
        {"arch": "hybrid", "embed_dim": 768, "n_heads": 12, "n_layers": 12, "batch_size": 1024, "precision": "fp8",  "max_seq_len": 512},
        {"arch": "hybrid", "embed_dim": 768, "n_heads": 12, "n_layers": 12, "batch_size": 2048, "precision": "fp8",  "max_seq_len": 512},
    ]
